...
import com.oscarparty.data.nominees.Category;
...
/**
 * Servlet for players to select who they think will win.
 */
public class SelectionServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        RequestDispatcher requestDispatcher = getServletContext().getRequestDispatcher("/playerSelection.jsp");
